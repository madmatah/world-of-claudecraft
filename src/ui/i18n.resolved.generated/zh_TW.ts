...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "options": {
      ...
      "gpuBackendVerdict": "上次後端測試：{backend}。",
      "gpuBackendVerdictStale": "上次後端測試的結果已不再適用於這台電腦。請重新執行測試以選擇後端。",
      "testBackends": "測試圖形後端",
      "testBackendsNote": "重新啟動遊戲並進行一項測試（需要幾分鐘），測量這台電腦上每個圖形後端的表現，為「自動」選出最佳後端。",
      "probeRequestedTitle": "要執行圖形後端測試嗎？",
      "probeRequestedBody": "測試需要關閉遊戲。現在重新啟動進入測試嗎？目前的工作階段將結束。",
      "probeRequestedConfirm": "重新啟動進入測試",
      "probeRequestedCancel": "暫不",
