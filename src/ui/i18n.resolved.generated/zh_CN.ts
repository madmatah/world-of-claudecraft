...
export const zh_CN: EnTranslations = {
  ...
  "probe": {
    ...
    "consent": {
      "heading": "为这台电脑找出最合适的图形后端",
      "body": "测试会自动打开和关闭若干窗口，大约需要 {minutes} 分钟。两次测试之间，屏幕可能会空白几秒钟，这是正常现象，并非出错。请保持游戏关闭，笔记本电脑接上电源，在结果出现之前不要操作电脑。",
      "start": "开始测试",
      "cancel": "暂不"
    },
    "progress": {
      "waiting": "正在准备测试",
      "arm": "正在测试 {backend}，第 {step} 步，共 {total} 步",
      "overall": "测试 {index}/{total}",
      "between": "测试 {done}/{total} 已完成，正在开始下一项。",
      "busy": "电脑正忙于其他任务。请关闭其他程序后重新运行测试。"
    },
    "verdict": {
      "heading": "推荐这台电脑使用：{backend}",
      "workerOn": "着色器预热工作线程：开启",
      "workerOff": "着色器预热工作线程：关闭",
      "inconclusive": "测试无法得出结论。请在不打开其他程序的情况下重新运行。",
    ...
    "status": {
      ...
      "software": "此后端在这里只能进行软件渲染，无法运行游戏。",
      "noCorpus": "此版本缺少测试数据。",
      "capped": "此后端未能及时链接测试着色器。"
    }
  },
  "devCommand": {
    "dialogLabel": "开发者命令中心",
  ...
  "hudChrome": {
    ...
    "options": {
      ...
      "gpuBackendVerdict": "上次后端测试：{backend}。",
      "gpuBackendVerdictStale": "上次后端测试的结果已不再适用于这台电脑。请重新运行测试以选择后端。",
      "testBackends": "测试图形后端",
      "testBackendsNote": "重新启动游戏并进行一项测试（需要几分钟），测量这台电脑上每个图形后端的表现，为“自动”选出最佳后端。",
      "probeRequestedTitle": "要运行图形后端测试吗？",
      "probeRequestedBody": "测试需要关闭游戏。现在重新启动进入测试吗？当前会话将结束。",
      "probeRequestedConfirm": "重新启动进入测试",
      "probeRequestedCancel": "暂不",
