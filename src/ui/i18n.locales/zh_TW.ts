...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'probe.backend.vulkanParallel': 'Vulkan（平行著色器編譯）',
  'probe.backend.software': '軟體算繪',
  'probe.backend.unknown': '未知後端',
  'probe.consent.heading': '為這台電腦找出最合適的圖形後端',
  'probe.consent.body':
    '測試會自動開啟和關閉數個視窗，大約需要 {minutes} 分鐘。兩次測試之間，畫面可能會空白幾秒鐘，這是正常現象，並非發生錯誤。請保持遊戲關閉，筆記型電腦接上電源，在結果出現之前請勿操作電腦。',
  'probe.consent.start': '開始測試',
  'probe.consent.cancel': '暫時不要',
  'probe.progress.waiting': '正在準備測試',
  'probe.progress.arm': '正在測試 {backend}，第 {step} 步，共 {total} 步',
  'probe.progress.overall': '測試 {index}/{total}',
  'probe.progress.between': '測試 {done}/{total} 已完成，正在開始下一項。',
  'probe.progress.busy': '電腦正忙於其他工作。請關閉其他程式後重新執行測試。',
  'probe.verdict.heading': '推薦這台電腦使用：{backend}',
