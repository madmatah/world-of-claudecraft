...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'probe.backend.vulkanParallel': 'Vulkan（并行着色器编译）',
  'probe.backend.software': '软件渲染',
  'probe.backend.unknown': '未知后端',
  'probe.consent.heading': '为这台电脑找出最合适的图形后端',
  'probe.consent.body':
    '测试会自动打开和关闭若干窗口，大约需要 {minutes} 分钟。两次测试之间，屏幕可能会空白几秒钟，这是正常现象，并非出错。请保持游戏关闭，笔记本电脑接上电源，在结果出现之前不要操作电脑。',
  'probe.consent.start': '开始测试',
  'probe.consent.cancel': '暂不',
  'probe.progress.waiting': '正在准备测试',
  'probe.progress.arm': '正在测试 {backend}，第 {step} 步，共 {total} 步',
  'probe.progress.overall': '测试 {index}/{total}',
  'probe.progress.between': '测试 {done}/{total} 已完成，正在开始下一项。',
  'probe.progress.busy': '电脑正忙于其他任务。请关闭其他程序后重新运行测试。',
  'probe.verdict.heading': '推荐这台电脑使用：{backend}',
  'probe.verdict.workerOn': '着色器预热工作线程：开启',
  'probe.verdict.workerOff': '着色器预热工作线程：关闭',
  'probe.verdict.inconclusive': '测试无法得出结论。请在不打开其他程序的情况下重新运行。',
  'probe.verdict.explicitSetting': '图形后端已手动设置，在把该设置改为“自动”之前，此结果不会生效。',
  'probe.verdict.play': '开始游戏',
  'probe.verdict.rerun': '重新运行测试',
  'probe.verdict.switchToAuto': '将后端设置改为“自动”',
  'probe.verdict.close': '关闭',
  'probe.status.noWebgl2': '此后端无法在这台电脑上启动。',
